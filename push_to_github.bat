@echo off
chcp 65001 >nul
title Push Elite Farrow Edition to GitHub

echo ========================================================
echo   ELITE FARROW 10-MINUTE ENGINE (V2)
echo   Day ma nguon len GitHub de Deploy Streamlit Cloud
echo ========================================================
echo.

set REPO_URL=https://github.com/phat2814backup-quant/elite.git
...
if "%COMMIT_MSG%"=="" (
    set COMMIT_MSG=Deploy Elite Farrow 10-Minute Engine v2
)
...
if %ERRORLEVEL% equ 0 (
    ...
    echo  URL Repo: https://github.com/phat2814backup-quant/elite
    echo.
    echo  Bay gio ban co the vao https://share.streamlit.io/
    echo  de Deploy ung dung:
    echo    - Repository: phat2814backup-quant/elite
    echo    - Branch: main
